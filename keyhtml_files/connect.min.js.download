$(document).ready(function () {
    ...
    e = $(".accordion-menu li:not(.open) ul"), o = $(".accordion-menu li.active-page > a"), e.hide(), $(".accordion-menu li a").on("click", function () {
        var e = $(this).next("ul"), o = $(this).parent("li"), a = $(".accordion-menu > li.open");
        ...
        if ($("body").hasClass("small-screen-sidebar-active")) {
            ...
            o = e, a = new MouseEvent("click", {bubbles: !0, cancelable: !0, view: window}), o.dispatchEvent(a)
        }
        var o, a
        ...
        var e = $(this).next("ul"), o = $(this).parent("li"), a = $(".horizontal-bar-menu > ul > li.open");
    ...
    }), $(window).width() > 767 && $(".slimscroll").slimScroll({
        wheelStep: 5,
        touchScrollStep: 30,
        opacity: 0
    }).mouseover(function () {
